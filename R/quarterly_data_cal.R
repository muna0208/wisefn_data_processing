...
#연결
con <- d[d$TERM_TYP=='32' & d$CAL_YEAR >='2010' & d$CAL_YEAR <='2022', c('LAQ_YN', 'CAL_YEAR', 'CAL_QTR', 'Short_Term_Financial_Instruments', 'Short_Term_Available_for_Sale_Financial_Assets'), drop=FALSE]
con <- con[1:which(con$LAQ_YN=="1"), ]
#개별
sep <- d[d$TERM_TYP=='2' & d$CAL_YEAR >='2010' & d$CAL_YEAR <='2022', c('LAQ_YN', 'CAL_YEAR', 'CAL_QTR', 'Short_Term_Financial_Instruments', 'Short_Term_Available_for_Sale_Financial_Assets'), drop=FALSE]
