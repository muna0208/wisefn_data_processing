...
#연결
con <- d[d$TERM_TYP=='31' & d$CAL_YEAR >='2010' & d$CAL_YEAR <='2022', c('LAA_YN', 'CAL_YEAR', 'CAL_QTR', 'Sales'), drop=FALSE]
con <- con[1:which(con$LAA_YN=="1"), ]
#개별
sep <- d[d$TERM_TYP=='1' & d$CAL_YEAR >='2010' & d$CAL_YEAR <='2022', c('LAA_YN', 'CAL_YEAR', 'CAL_QTR', 'Sales'), drop=FALSE]
